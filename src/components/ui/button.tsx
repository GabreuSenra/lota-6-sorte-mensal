  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-prize",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-gradient-lucky text-primary-foreground hover:shadow-glow hover:scale-105 transition-bounce font-semibold",
        prize: "bg-gradient-prize text-secondary-foreground hover:shadow-prize hover:scale-105 transition-bounce font-bold",
        lucky: "bg-primary/10 text-primary border border-primary/30 hover:bg-primary hover:text-primary-foreground shadow-glow/50",
      },
      size: {
